defmodule Tpa.Auth.Guardian.StudentPipeline do
  ...
  plug(Guardian.Plug.VerifySession, claims: %{"typ" => "access", "role"=> "student"})
  # If there is an authorization header, restrict it to an access token and validate it
  plug(Guardian.Plug.VerifyHeader, claims: %{"typ" => "access", "role"=> "student"})
